        ...
        <div class="form-group">
            ...
            <div class="inputGroupContainer">
                <div class="input-group">
                    ...
                    {{Form::date('when',$dataPet->AdPetDisappeared->when, array('placeholder' => 'Data de desaparecimento','class' => 'form-control','data-format' => 'dd/MM/yyyy','max'=> date('Y-m-d'), 'required'))}}
                </div>
                <div class="help-block with-errors"></div>
            </div>
        </div>
