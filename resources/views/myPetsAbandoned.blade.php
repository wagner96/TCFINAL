            ...
            @foreach($pets as $pet)
                <tr>
                    ...
                    <td align="center">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary">
                                            <a href="{{url('adocao/animal/'.$pet->id)}}" style="color: #ffffff">Ver
                                                anúncio</a>
                                        </button>
                                    </div>
                                </div>
                        ...
                        <a href="{{url('meus_amigos_p_adoção/editar/'.$pet->id)}}" data-original-title="Editar" class="btn btn-primary"><span
